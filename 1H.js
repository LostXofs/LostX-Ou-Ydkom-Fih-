...
loopy() 
function loopy() {
    var correctUsername = "@LostXofs"; // استبدل باسم المستخدم الصحيح هنا
    var correctPassword = "isso"; // كلمة السر الصحيحة
    ...
    window.alert("𝗪𝗔𝗟𝗖𝗢𝗠 𝗧𝗢 𝗠𝗬 𝗣𝗔𝗡𝗘𝗟 ( Olá meus amigos brasileiros ) ");
}
