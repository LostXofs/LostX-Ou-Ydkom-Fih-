  // Set the target date to 30 days from now
        ...
        document.getElementById("target-date").innerText = formatDate(targetDate);

        function updateCountdown() {
            document.getElementById("datetime").innerText = getRemainingTime(targetDate);
        }

        // Update the countdown every second
        setInterval(updateCountdown, 1000);
        updateCountdown(); // Initial call to set the first value
